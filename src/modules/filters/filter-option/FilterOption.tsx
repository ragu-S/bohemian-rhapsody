...
const FilterOption = ({ id, type, value, label, onUpdateSelectedFilters }: { id: string, type:string, value: boolean, label: string, onUpdateSelectedFilters: TUpdateSelectedFilters }) => {
        ...
        <div className="flex h-5 shrink-0 items-center">
          <div className="group grid size-4 grid-cols-1">
            <input
              ...
              type="checkbox"
              checked={value}
              onChange={() => onUpdateSelectedFilters({ type, label })}
